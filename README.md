...
1. Explain how to build stateful class components.
   Simply assign the state to the things you want to hold. Can be done in constructor, but is no longer needed.

2. Describe the different phases of the component lifecycle.
   Mounting, is the start of the cycle, its putting the component onto the DOM.
   Updating, is where props and other states can change, causing an re-render of the components to the DOM
   Unmounting, removing components from the DOM.

3. Demonstrate an understanding of class component lifecycle methods.
   You can use DidMount on the comonent to trigger code as soon as the component is put onto the DOM, most useful with fetching from a API.

4. Define stateful logic.
   Based on values in the state you can have different effects happend with a component.

5. Describe how to test a React component with React Testing Library.
   Arrange, setting up the redering the the component being tested. Act, setting var to things placed on the DOM. Assert test conditions of the vars or other things on the DOM.
